...
public class BodyPartQuiz {
	...
	// package or if you prefer, get celebrity photos from the Internet, place
	// them in the default package, and change the names below.
	...
	private void startQuiz() {
		...
		for (int i = 0; i < 4; i++) {
			...
			if (i == 0 && guess.toLowerCase().equals("arnold")) {
				JOptionPane.showMessageDialog(null, "Correct!");
				score++;
			} else if (i == 1 && guess.toLowerCase().equals("leonardo")) {
				JOptionPane.showMessageDialog(null, "Correct!");
				score++;
			} else if (i == 2 && guess.toLowerCase().equals("morgan")) {
				JOptionPane.showMessageDialog(null, "Correct!");
				score++;
			} else if (i == 3 && guess.toLowerCase().equals("jack")) {
				JOptionPane.showMessageDialog(null, "Correct!");
				score++;
			} else {
