...
public class DrumKit implements MouseListener {
	...
	private void getGoing() throws MalformedURLException {
		...
		String drumImageString = "drum.png";
		// 9. Edit the next line to use your String variable
		drumLabelWithImage = createLabelImage(drumImageString);
		drumLabelWithImage.setName("drum");
		...
		// each one.
		drumImageString = "snare.jpg";
		drumLabelWithImage = createLabelImage(drumImageString);
		drumLabelWithImage.setName("snare");
		panel.add(drumLabelWithImage);
		drumLabelWithImage.addMouseListener(this);

		drumImageString = "cymbal.jpg";
		drumLabelWithImage = createLabelImage(drumImageString);
		drumLabelWithImage.setName("cymbal");
		panel.add(drumLabelWithImage);
		drumLabelWithImage.addMouseListener(this);
		frame.pack();
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (drumClicked.getName().equals("drum")) {
			playSound("drum.wav");
		} else if (drumClicked.getName().equals("snare")) {
			playSound("homer-woohoo.wav");
		} else if (drumClicked.getName().equals("cymbal")) {
